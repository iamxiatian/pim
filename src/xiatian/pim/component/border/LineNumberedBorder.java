package xiatian.pim.component.border;
...
public class LineNumberedBorder extends AbstractBorder {
    private static final long serialVersionUID = -7546366223199674742L;
    ...
    private int lineNumberWidth(JTextPane textPane) {
        ...
        return textPane.getFontMetrics(
                textPane.getFont()).stringWidth(lineCount + " ");
    }
