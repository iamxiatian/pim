...
public class DateField extends JPanel implements ActionListener, PropertyChangeListener {
  private static final long serialVersionUID = -5015129703241907225L;
  ...
  class WindowPanel extends JDialog {
    ...
    private void init(boolean showWeekNumbers) {
      ...
      if (showOkCancel) {
        ...
        /*
         * datepanel.addChangeListener(new ChangeListener() { public void
         * stateChanged(ChangeEvent e) { aceptar(); } });
         */
