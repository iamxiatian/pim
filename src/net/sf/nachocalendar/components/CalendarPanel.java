...
public class CalendarPanel extends JPanel implements ChangeListener {
  private static final long serialVersionUID = 5940445017893695352L;
  ...
  private void initDisplayPanel() {
    int displayRange = cal.get(Calendar.MONTH); // first we have to retrieve the
                                                // month
    setShowingYear(cal.get(Calendar.YEAR)); // next we set the year (and change
                                            // the cal)
  ...
  private void createListeners() {
     ...
     * monthIncreased(MonthChangeEvent e) { setDate(e.getDate()); }
     * 
