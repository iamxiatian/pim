...
public class DatePanel extends JPanel {
    private static final long serialVersionUID = 4322500199081321722L;
    ...
    private void addListeners() {
         ...
         * yearscroller.setYear(cal.get(Calendar.YEAR)); monthpanel.setMonth(new
         * Date()); monthpanel.setDay(new Date());
         */
            }
        });
    }
    ...
    public boolean isEnabled() {
        if (monthpanel == null) return true;
     ...
     * @param listener The listener to register.
     */
    public synchronized void addMonthChangeListener(net.sf.nachocalendar.event.MonthChangeListener listener) {
        if (listenerList == null) {
            listenerList = new javax.swing.event.EventListenerList();
        }
     ...
     * @param listener The listener to remove.
     */
    public synchronized void removeMonthChangeListener(net.sf.nachocalendar.event.MonthChangeListener listener) {
